...
The sample statistic $b$ is an estimator for the slope parameter, $\beta$, whose can only be known when data is available for a full population. The three figures below show calculated values of $b$ from samples compared to $\beta$.
