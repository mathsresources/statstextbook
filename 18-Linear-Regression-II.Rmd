...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw[very thick,RoyalBlue,dashed] (3,1) -- (3,2);
...
\begin{center}
    \begin{tikzpicture}[scale=0.9]
        ...
        \draw[ForestGreen,fill] (1,1) circle (0.05);
        \draw[ForestGreen,fill] (3,0.7) circle (0.05);
        \draw[ForestGreen,fill] (4,2) circle (0.05);
        \draw[ForestGreen,fill] (6,1.2) circle (0.05);
        \draw[red,fill] (2,-0.5) circle (0.05);
        \draw[red,fill] (5,-0.8) circle (0.05);
        \draw[red,fill] (7,0) circle (0.05);
        \node[ForestGreen] at (7,2) {\textit{positive residuals}};
        \node[red] at (7,-1) {\textit{negative residuals}};
    \end{tikzpicture}
\end{center}
...
\draw[fill,red] (10*0.2,8*0.12) circle (0.05);
\draw[thick] (10*0.2,8*0.12) -- (10*0.2,11.6*0.12);
\draw[fill=black] (15*0.2,17*0.12) circle (0.02);
\draw[fill,ForestGreen] (16*0.2,18*0.12) circle (0.05);
    \end{tikzpicture}
\end{center}
...
The *error variance* is the variance of the population of data *relative to the regression line's predicted values*, loosely indicated below by blue arrows. This is distinct from the *total variance* of $Y$, loosely indicated by the purple arrow.
...
\draw[fill] (8.486224,3.7495115) circle (0.05);
    \draw[ultra thick,RoyalBlue,stealth-stealth] (1,1*0.39+2.13+1.1) -- (1,1*0.39+2.13-1.1);
    \draw[ultra thick,RoyalBlue,stealth-stealth] (3,3*0.39+2.13+1.1) -- (3,3*0.39+2.13-1.1);
    \draw[ultra thick,RoyalBlue,stealth-stealth] (5,5*0.39+2.13+1.1) -- (5,5*0.39+2.13-1.1);
    \draw[ultra thick,RoyalBlue,stealth-stealth] (7,7*0.39+2.13+1.1) -- (7,7*0.39+2.13-1.1);
    \draw[ultra thick,RoyalBlue,stealth-stealth] (9,9*0.39+2.13+1.1) -- (9,9*0.39+2.13-1.1);
    \draw[ultra thick,Plum,stealth-stealth] (15,4.1+2) -- (15,4.1-2);
    \node[RoyalBlue] at (6,1) {constant variance of the errors};
    \node[Plum] at (15,1) {total variance of $Y$};
    \end{tikzpicture}
\end{center}
...
Where the (always positive) \textit{sum of squared residuals}, $SSR$, is calculated as:\hspace{0.5cm} $SSR=S_{yy}-\dfrac{(S_{xy})^2}{S_{xx}}$

Both the formula for estimating the error variance $\sigma^2$ and the more convenient second formula for the sum of squared residuals $SSR$ are given on page 5 of the Data Booklet.
...
\text{(a)   } $SSR=S_{yy}-\dfrac{(S_{xy})^2}{S_{xx}}=256.25-\dfrac{255^2}{290}=32.026$\\[0.7em]
...
The sample statistic $b$ is an estimator for the slope parameter, $\beta$, whose can only be known when data is available for a full population. The following three possibilities for the true value of $\beta$ are of interet.
...
\begin{minipage}[c]{.33\textwidth}
  \centering
\begin{centering}
\begin{tcolorbox}[center,colback=red!5,colframe=red!70!black,width=6cm,height=2.3cm]
...
\begin{minipage}[c]{.66\textwidth}
  \centering
\begin{tcolorbox}[center,colback=red!5,colframe=red!70!black,width=12cm,height=2.3cm]
\textbf{Requirements:}
\vspace{0.1cm}
\begin{itemize}
...
\vspace{-0.2cm}
Any conclusion should comment on the evidence for the model being useful for prediction.
...
\begin{minipage}[c]{.33\textwidth}
  \centering
\begin{centering}
\begin{tcolorbox}[center,colback=red!5,colframe=red!70!black,width=6cm,height=2.6cm]
\textbf{Test statistic:}
...
\begin{minipage}[c]{.66\textwidth}
  \centering
\begin{tcolorbox}[center,colback=red!5,colframe=red!70!black,width=12cm,height=2.6cm]
\textbf{Requirements:}
\vspace{0.1cm}
\begin{itemize}
...
Since $-3.003>-3.707$, do not reject $\text{H}_0$ at the 1\% level of significance. There is insufficient evidence to suggest that there is a linear relationship between the two variables.
...
All of the equations of least square regression lines calculated so far have been $y$ *on* $x$ regression lines, calculated with a goal of minimising errors when predicting $y$ *values*. However, a $y$ *on* $x$ regression line model cannot be used to predict $x$ values.

Instead it is necessary to create a new model and obtain the equation of an $x$ *on* $y$ regression line, of form:

\begin{tcolorbox}[center,colback=red!5,colframe=red!70!black,width=4cm]
\vspace{-0.5cm}
\[\hat{X}=a+by\]
\end{tcolorbox}
...
\begin{tcolorbox}[center,colback=red!5,colframe=red!70!black,width=6cm]
\vspace{-0.5cm}
