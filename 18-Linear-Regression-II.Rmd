...
\begin{tcolorbox}[title=Example,colback=RoyalBlue!1!, colframe=RoyalBlue]
\textbf{Problem:} A bivariate sample of 8 values produces a regression line with equation $\hat{Y}=7.9-0.8456x$. The following summary statistics were also obtained:
