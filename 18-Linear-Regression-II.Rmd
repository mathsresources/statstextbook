...
Students sitting a French exam are given a mark for each of the two components: speaking ($x$) and listening ($y$). From a random sample of 12 students: $S_{xx}=290,S_{yy}=256.25,S_{xy}=255$.\\
...
This suggests that 87.4\% of the variation in listening scores can be explained by the linear model.

\end{tcolorbox}

The conclusion from the example above could also be phrased as:

"*87.4\% of the variation in listening scores can be explained by the theory scores.*"
...
Determine the equation for the least squares regression line of $x$ on $y$, and hence predict the theory paper mark for a student who has only sat the listening paper and obtained a mark of 17 in it.
