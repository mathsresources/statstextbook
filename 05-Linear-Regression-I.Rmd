...
\textbf{Problem:} A French class takes two tests; \textit{listening} and \textit{reading}. The results of the 9 pupils are shown in the table and scatterplot below. Comment on the scatterplot.
...
\begin{tcolorbox}[title=Example,colback=RoyalBlue!1!,colframe=RoyalBlue]
\textbf{Problem:} A French class takes two tests; \textit{listening} and \textit{reading}. The results of the 9 pupils are shown in the scatterplot below, along with some summary statistics. Comment on the scatterplot.
