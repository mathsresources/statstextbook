...
\begin{enumerate}[itemsep=20pt]
    ...
    \begin{enumerate}
        ...
        \item The sample standard deviation was considered a reliable estimator for the population standard deviation of recovery time, since the sample was sufficiently large. Determine the value of the sample standard deviation used to calculate the confidence interval.
    \end{enumerate}
