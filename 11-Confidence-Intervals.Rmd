...
\begin{centering}
\tcbset{width=15cm}
\begin{tcolorbox}[adjusted title=Conditions for a one-sample $z$-test for the population mean:, halign title = center,colback=red!5,colframe=red!70!black, halign = center,center]
\begin{itemize}
...
\begin{centering}
\tcbset{width=15cm}
\begin{tcolorbox}[adjusted title=Conditions for a one-sample $t$-test for the population mean:, halign title = center,colback=red!5,colframe=red!70!black, halign = center,center]
\begin{itemize}
...
The sampling distribution of the sample proportion, $\hat{P}$, has the standard error: $\sqrt{\dfrac{pq}{n}}$.
...
\begin{centering}
\tcbset{width=15cm}
\begin{tcolorbox}[adjusted title=Conditions for a one-sample $z$-test for the population proportion:, halign title = center,colback=red!5,colframe=red!70!black, halign = center,center]
\begin{itemize}
