...
$\overline{X}\sim \text{N}\left(180,\dfrac{0.4^2}{9}\right)$\\[0.1cm]
...
\node[below] at (10,-0.5) {$0$};
        ...
        \draw[fill=black!10] (0.5+10,0) rectangle (0.7+10,0.15*9);
        \draw[fill=black!10] (0.7+10,0) rectangle (0.9+10,0.15*23);
        \draw[fill=black!10] (0.9+10,0) rectangle (1.1+10,0.15*25);
        \draw[fill=black!10] (1.1+10,0) rectangle (1.3+10,0.15*24);
        \draw[fill=black!10] (1.3+10,0) rectangle (1.5+10,0.15*13);
        \draw[fill=black!10] (1.5+10,0) rectangle (1.7+10,0.15*5);
        \draw[fill=black!10] (1.7+10,0) rectangle (1.9+10,0.15*1);
        \draw[fill=black!10] (1.9+10,0) rectangle (2.1+10,0.15*0);
        \draw[fill=black!10] (2.1+10,0) rectangle (2.3+10,0.15*1);
        \draw[fill=black!10] (2.3+10,0) rectangle (2.5+10,0.15*0);
        \draw[thick,domain=-2.8:2.8
        ,smooth,samples=50,yscale=9.5,xshift=11cm,xscale=0.4] plot (\x,{1/((2*3.14)^0.5)) * 2.718^(-0.5*(\x)^2)});
    \end{tikzpicture}
\end{center}
