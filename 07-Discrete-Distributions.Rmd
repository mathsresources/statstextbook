...
The  Data Booklet gives the **formula** to calculate *individual* probabilities for the binomial distribution, where $q$ is the probability of *failure*, and hence $q=1-p$:
...
The  Data Booklet gives the formulae for the *mean* and *variance* of the binomial distribution.
...
As with the binomial distribution, individual Poisson probabilities can be calculated using a formula, provided in the  Data Booklet.
...
As with the binomial distribution, in general it is much faster to use the cumulative probability tables in the Data Booklet, or a graphical calculator, to calculate Poisson probabilities.
