...
### Poisson Calculations using Cumulative Probabilities
...
\begin{enumerate}
    ...
    \item A city is experiencing problems with the number of pieces of chewing gum stuck to pavements. A worker from the council's environmental health department notes that in the city's main pedestrian square, that the mean number of pieces of chewing gum per square paving stone was 1.5.\\[0.5em]
    It may be assumed that the number of pieces on a paving stone, $X$, follows a Poisson distribution. 
    \begin{enumerate}
        \item State the distribution of $X$.
        \item Use the Data Booklet to calculate the probability that a randomly selected paving stone contains at least one of chewing gum.
    \end{enumerate}
