...
\begin{tcolorbox}[title=Example,colback=RoyalBlue!1!,colframe=RoyalBlue,height=6cm]
...
\begin{align*}
    \text{V}(aX+ b)&=\text{E}[((aX+ b)-(\text{E}(aX+ b))^2]\\[0.5em]
    &=\text{E}[(aX+b-a\text{E}(X)-b)^2]\\[0.5em]
    &=\text{E}[(aX-a\text{E}(X))^2]\\[0.5em]
    &=\text{E}[(a(X-\text{E}(X)))^2]\\[0.5em]
...
\begin{centering}
\tcbset{width=14cm}
\begin{tcolorbox}[adjusted title=For \textbf{independent} random variables $X$ and $Y$:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
\vspace{-0.3cm}
\begin{equation*}
  \begin{split}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Assuming that $J$ and $K$ are such that the those laws may be applied, find:
    \begin{enumerate}
        \begin{multicols}{3}
            \item $\text{E}(J+K)$
            \item $\text{E}(J-K)$
