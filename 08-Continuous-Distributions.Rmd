...
$\text{P}(X>300)=\text{P}\left(Z>\dfrac{\text{$300-295$}}{\text{$15$}}\right)=\text{P}(Z>0.33)=0.3707$\\
...
$\text{V}(T)=8\times\text{V}(X)=8\times0.3^2=0.72$\\[0.1em]
...
\begin{align*}
\text{P}(15\leqslant T \leqslant 20)= &\text{P}\left(\frac{14.5-25}{\sqrt{25}}<Z<\frac{20.5-25}{\sqrt{25}}\right)&\\[0.2em]
