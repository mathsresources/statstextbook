...
Data that results from measuring is often continuous, such as the height of a person, the mass of a piece of fruit or the volume of tea in a cup. *Continuous* means that if there were no limits to the precision of a measuring device, there would be infinitely many possible values in any given interval. A **continuous random variable** can take any value within a continuous range of real numbers, rather than a list of separate values. For example, the time taken to complete a task could be *any positive real number*, which can be written as $\{x\in \mathbb{R} : x>\text{0}\}$.

### Probability and Continuous Distributions {-}

Since a continuous random variable can take infinitely many values in any interval, probabilities are assigned to ranges of values rather than individual values. Consequently, for any specific value $x$, $\text{P}(X=x)=\text{0}$. For example, let random variable $X$ represent the time taken to complete a task, measured in seconds. Then it is possible that:

\vspace{-0.4cm}

$$\text{P}(X=\text{26})=\text{0}\quad \textit{ but }\quad \text{P}(\text{24}<X<\text{28.5})=\text{0.5328}$$
...
\draw[semithick,-stealth] (axis cs: -3.2,-0.01) -- (axis cs: 3.2,-0.01) node[below] {$x$}; 
\draw[semithick,-stealth] (axis cs: -3.2,-0.01) -- (axis cs: -3.2,0.5);
\node[left,text width=2cm,align=center] at (axis cs: -3.2,0.4) {probability density};
\end{axis}
\end{tikzpicture}
\end{center}
...
\fill[Black!20] (axis cs: 2,0) rectangle (axis cs: 7,0.3);
...
\begin{centering}
\tcbset{width=8cm}
\begin{tcolorbox}[adjusted title=The Continuous Uniform Distribution:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
\begin{itemize}
    \item Notated $X\sim \text{U}(a,b)$.
    \item Defined by two parameters, $a$ and $b$.
    \item Takes \textbf{continuous} values from $a$ to $b$.
...
$$k=\frac{1}{b-a}\quad \qquad \quad \text{E}(X)=\frac{a+b}{\text{2}}\quad \qquad \quad \text{V}(X)=\frac{(b-a)^\text{2}}{\text{12}}$$

\begin{tcolorbox}[title=Example,colback=RoyalBlue!1!,colframe=RoyalBlue]
\textbf{Problem:} Given random variable $T$ such that $T\sim \text{U}(\text{27},\text{42})$, calculate $\text{P}(\text{31}<T<\text{34})$.
...
$k=\frac{\text{1}}{b-a}=\frac{\text{1}}{\text{42}-\text{27}}=\frac{\text{1}}{\text{15}}$

\vspace{0.5cm}

$\text{P}(\text{31}<T<\text{34})=\text{3}\times \frac{\text{1}}{\text{15}}=\frac{\text{3}}{\text{15}}=\frac{\text{1}}{\text{5}}$
\hspace{3cm}
...
\fill[Black!20] (axis cs: 2.7,0) rectangle (axis cs: 4.2,0.3);
...
\begin{enumerate}[itemsep=12pt]
    \item Explain why, for each, random variable $X$ does \textbf{not} follow a $\text{U}(a,b)$ distribution.
    \begin{enumerate}
        \item Let $X$ represent the height of an adult.
        \item Let $X$ represent the score from a fair six-sided die.
        \item Let $X$ represent the lifetime of a light bulb.
        \item Let $X$ represent the arrival time of a randomly selected pupil, between 8am and 9am.
    \end{enumerate}
    \item The continuous random variable $X$ is uniformly distributed over the interval $[\text{6},\text{15}]$. Find:
    \begin{enumerate}
        \item $\text{P}(X<\text{12})$.
        \item $\text{P}(X>\text{8.1})$.
        \item $\text{P}(\text{9.3}<X<\text{10.2})$.
    \end{enumerate}
\end{enumerate}
...
\begin{enumerate}[resume]
    \item The continuous random variable $X$ is uniformly distributed over the interval $[\text{24},\text{36}]$. Find:
    \begin{enumerate}
        \item $\text{P}(X\geqslant\text{32})$.
        \item $\text{P}(X=\text{29.5})$.
        \item $\text{P}(\text{26.1}\leqslant X\leqslant\text{34})$.
    \end{enumerate}
    \item The continuous random variable $Y$ is uniformly distributed over the interval $[\text{1.6},\text{4}]$. Find:
    \begin{enumerate}
        \item $\text{P}(Y<\text{2})$.
        \item $\text{P}(\text{2}<Y<\text{5})$.
        \item $\text{P}(Y+\text{1}>\text{4})$.
    \end{enumerate}
    \item The continuous random variable $X$ is uniformly distributed over the interval $[-\text{4},\text{6}]$.
    \begin{enumerate}
        \item Evaluate the mean and standard deviation of $X$.
        \item Calculate $\text{E}(\text{3}X-\text{1})$ and $\text{V}(\text{5}-\text{2}X)$.
        \item Find $\text{P}(X\leqslant \text{2.4})$.
        \item Find $\text{P}(-\text{3}<X-\text{5}<\text{3})$.
    \end{enumerate}
    ...
    \end{enumerate}
    \item A manufacturer produces sweets of length $L$ millimetres, where $L$ has a continuous uniform distribution with range $[\text{15},\text{30}]$.
    \begin{enumerate}
    ...
    \end{enumerate}
    \item Given continuous random variable $X$ such that $X\sim \text{U}(\text{1},\text{15})$:
    \begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Determine $\text{P}(X<\text{7})$.
    \end{enumerate}
    \item Given that continuous random variable $X$ is uniformly distributed such that $\text{E}(X)=\text{19}$ and $\text{SD}(X)=\sqrt{\text{3}}$:
    \begin{enumerate}
        \item Find the distribution of $X$.
        \item Determine $\text{P}(\text{E}(X)-\text{SD}(X)<X<\text{E}(X)+\text{SD}(X))$.
    \end{enumerate}
\end{enumerate}
...
\node[above] at (axis cs: 0,\valueA)  {$\text{N}(\mu,\sigma^\text{2})$};
...
\begin{center}
\begin{equation*}
\textbf{pdf: }\quad\frac{\text{1}}{\sigma\sqrt{\text{2}\pi}}e^{-\frac{\text{1}}{\text{2}}\left(\frac{x-\mu}{\sigma}\right)^\text{2}}
\end{equation*}
\end{center}
...
\begin{centering}
\tcbset{width=10cm}
\begin{tcolorbox}[adjusted title=The Normal Distribution:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
\begin{itemize}
    \item Notated $X\sim \text{N}(\mu,\sigma^\text{2})$.
    \item Defined by two parameters, $\mu$ and $\sigma$.
    \item Often described as a \textit{"bell-shaped curve"}.
    \item $\mu$ (the \textbf{mean}) determines the \textit{location} of the curve.
    \item $\sigma$ (the \textbf{standard deviation}) determines the \textit{spread} of the curve.
...
\node[anchor=south] at (axis cs: 16,\valueA) {$\text{N}(\text{16},\text{4}^\text{2})$};
\node[anchor=south] at (axis cs: 68,\valueB) {$\text{N}(\text{68},\text{9}^\text{2})$};
...
\closedcycle;
\addplot [draw=none, fill=Black!20, domain=-2:2] {gauss(x, 0, 1)}
\closedcycle;
...
\node[below] at (axis cs: -1,0)  {$-\text{1}\sigma$};
\node[below] at (axis cs: 1,0)  {$+\text{1}\sigma$};
\node[below] at (axis cs: -2,0)  {$-\text{2}\sigma$};
\node[below] at (axis cs: 2,0)  {$+\text{2}\sigma$};
\node[below] at (axis cs: -3,0)  {$-\text{3}\sigma$};
\node[below] at (axis cs: 3,0)  {$+\text{3}\sigma$};
\node[above] at (axis cs: 0,\valueA)  {$\mu$};
\fill[Black!10] (axis cs: -3,-0.01) rectangle (axis cs: 3,0);
\fill[Black!20] (axis cs: -2,-0.01) rectangle (axis cs: 2,0);
...
\begin{enumerate}[itemsep=0pt]
    ...
    \begin{enumerate}
        \begin{multicols}{4}
        \item $X\sim \text{N}(\text{60},\text{16})$
        \item $X\sim \text{N}(\text{8},\text{1.3}^\text{2})$
        \item $X\sim \text{N}(\text{243},\text{9})$
        \item $X\sim \text{N}(\text{15},\text{1.44})$
        \end{multicols}
    \end{enumerate}
    \vspace{-0.3cm}
    \item The mass of a variety of pumpkin is normally distributed with mean 7kg and standard deviation 2kg.
    \item The time taken to polish a spoon is normally distributed with $\mu=\text{8}$ and $\sigma=\text{1.5}$ (measured in seconds).
    \item The depth of water in a city's puddles after heavy rain is normally distributed with mean 32mm and variance 81$\text{mm}^\text{2}$.
\end{enumerate}
...
\node[below] at (axis cs: -1,0)  {$-\text{1}$};
\node[below] at (axis cs: 1,0)  {$\text{1}$};
\node[below] at (axis cs: -2,0)  {$-\text{2}$};
\node[below] at (axis cs: 2,0)  {$\text{2}$};
\node[below] at (axis cs: -3,0)  {$-\text{3}$};
\node[below] at (axis cs: 3,0)  {$\text{3}$};
\node[below] at (axis cs: 0,0)  {$\text{0}$};
\node[above] at (axis cs: 0,\valueA)  {$Z\sim \text{N}(\text{0},\text{1})$};
...
\begin{align*}
\text{P}(Z>\text{0.71})=&\text{1}-\text{P}(Z<\text{0.71})\\
=&\text{1}-\text{0.7611}\\
=&\text{0.2389}
\end{align*}
...
\node[below] at (axis cs: -1.05,0)  {$-\text{1.05}$};
\node[below] at (axis cs: 0,0)  {0};
\node[above] at (axis cs: 0,\valueB)  {$Z$};
\draw[semithick] (axis cs: -3,-0.02) -- (axis cs: 3,-0.02);
\end{axis}
...
\begin{align*}
\text{P}(Z>-\text{1.05})=&\text{P}(Z<\text{1.05})\\
=&\text{0.8531}
\end{align*}
...
\begin{align*}
\text{P}(\text{0.7}<Z<\text{1.5})=&\text{P}(Z<\text{1.5})-\text{P}(Z<\text{0.7})\\
=&\text{0.9332}-\text{0.7580}\\
=&\text{0.1752}
\end{align*}
...
\begin{enumerate}
    ...
    \begin{multicols}{4}
    \begin{enumerate}
        \item[(a)] $\text{P}(Z=\text{1.72})$
        \item[(e)] $\text{P}(Z<\text{0.35})$
        \item[(i)] $\text{P}(Z<-\text{1.19})$
        \item[(b)] $\text{P}(Z<\text{1.72})$
        \item[(f)] $\text{P}(Z<\text{2.03})$
        \item[(j)] $\text{P}(Z>-\text{0.56})$
        \item[(c)] $\text{P}(Z\leqslant\text{1.72})$
        \item[(g)] $\text{P}(Z>\text{2.03})$
        \item[(k)] $\text{P}(Z>-\text{1.44})$
        \item[(d)] $\text{P}(Z<\text{0})$
        \item[(h)] $\text{P}(Z>\text{1.19})$
        \item[(l)] $\text{P}(Z<-\text{0.57})$
    \end{enumerate}
    \end{multicols}
    \item Find:
    \begin{multicols}{3}
    \begin{enumerate}
        \item[(a)] $\text{P}(\text{1.3}<Z<\text{2})$
        \item[(d)] $\text{P}(-\text{1.54}<Z<-\text{0.76})$
        \item[(g)] $\text{P}(-\text{2}<Z<\text{2})$
        \item[(b)] $\text{P}(\text{0.48}<Z<\text{1.93})$
        \item[(e)] $\text{P}(-\text{0.7}<Z<\text{1.3})$
        \item[(h)] $\text{P}(-\text{1.96}<Z<\text{1.96})$
        \item[(c)] $\text{P}(-\text{2.3}<Z<-\text{1.7})$
        \item[(f)] $\text{P}(-\text{1}<Z<\text{1})$
        \item[(i)] $\text{P}(-\text{1.64}<Z<\text{1.64})$
    \end{enumerate}
    \end{multicols}
\end{enumerate}
...
A linear transformation of a normally distributed random variable will result in *another* normally distributed random variable, with the laws of expectation and variance applying as usual. In this way, any normally distributed variable can be related to the *standard normal distribution*, $Z$. Consider a random variable $X$ with mean $\mu$ and variance $\sigma^\text{2}$:

$$X\sim \text{N}(\mu,\sigma^\text{2})$$

Multiplying $Z$ by $\sigma$ and adding $\mu$ results in a normally distributed random variable with mean $\mu$ and variance $\sigma^\text{2}$:

\begin{equation*}
  \begin{split}
    \text{E}(\sigma Z + \mu) &= \sigma \text{E}(Z)+\mu\\[10pt]
    &= \sigma \times \text{0} + \mu\\[10pt]
    &= \mu
  \end{split}
\quad\quad\quad\quad
  \begin{split}
    \text{V}(\sigma Z + \mu) &= \sigma^\text{2} \text{V}(Z)\\[10pt]
    &= \sigma^\text{2} \times \text{1}\\[10pt]
    &= \sigma^\text{2}
  \end{split}
\end{equation*}

Hence $X=\sigma Z + \mu$, which can be rearranged to obtain the $\mathbf{z}$**-transformation** for any normal random variable $X\sim \text{N}\left(\mu,\sigma^\text{2}\right)$:

\begin{centering}
\tcbset{width=9cm}
\begin{tcolorbox}[adjusted title=The $z$-transformation:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
$Z=\dfrac{X-\mu}{\sigma}$
\end{tcolorbox}
\end{centering}
...
$$z=\frac{x-\mu}{\sigma}=\frac{\text{29}-\text{20}}{\text{6}}=\text{1.5}$$

Hence, a probability statement about $X$ can be rewritten as a probability statement about $Z$:

$$\text{P}(X<\text{29})=\text{P}\left(Z<\dfrac{x-\mu}{\sigma}\right)=\text{P}\left(Z<\dfrac{\text{29}-\text{20}}{\text{6}}\right)=\text{P}(Z<\text{1.5})$$
...
\begin{tcolorbox}[title=Example,colback=RoyalBlue!1!,colframe=RoyalBlue]
\textbf{Problem:} The mass of an adult red squirrel in an area of woodland is normally distributed with a mean of 295g and a standard deviation of 15g. Calculate the probability that a squirrel chosen at random has a mass greater than 312g.
...
$X\sim \text{N}(\text{295},\text{15}^\text{2})$\\

$\text{P}(X>\text{312})=\text{P}\left(Z>\dfrac{\text{312}-\text{295}}{\text{15}}\right)=\text{P}(Z>\text{1.13})=\text{0.1292}$\\
...
\addplot [draw=none, fill=Black!20, domain=1.13:3] {gauss(x, 0, 1)} 
\closedcycle;
 \addplot [semithick] {gauss(x, 0, 1)};
\pgfmathsetmacro\valueA{gauss(1.13,0,1)}
\pgfmathsetmacro\valueB{gauss(0,0,1)}
\fill[Black!20] (axis cs: 1.13,-0.02) rectangle (axis cs: 3,0);
\draw [semithick, black]  (axis cs:1.13,-0.02) -- (axis cs:1.13,\valueA);
\node[below] at (axis cs: 1.13,0)  {312};
\node[above] at (axis cs: 0,\valueB)  {$X$};
\node[below] at (axis cs: 0,0)  {295};
\draw[semithick] (axis cs: -3,-0.02) -- (axis cs: 3,-0.02);
\node at (axis cs: 2.1,0.2)  {12.92\%};
\end{axis}
\end{tikzpicture}
...
\fill[Black!20] (axis cs: 1.13,-0.02) rectangle (axis cs: 3,0);
\draw [semithick, black]  (axis cs:1.13,-0.02) -- (axis cs:1.13,\valueA);
\node[below] at (axis cs: 1.13,0)  {1.13};
\node[above] at (axis cs: 0,\valueB)  {$Z$};
\node[below] at (axis cs: 0,0)  {0};
\draw[semithick] (axis cs: -3,-0.02) -- (axis cs: 3,-0.02);
\node at (axis cs: 2.1,0.2)  {12.92\%};
...
\begin{enumerate}
    \item Given $X\sim \text{N}(\text{24},\text{9})$, find:
    \begin{multicols}{4}
    \begin{enumerate}
        \item $\text{P}(X<\text{26})$
        \item $\text{P}(X\leqslant\text{21})$
        \item $\text{P}(X>\text{23})$
        \item $\text{P}(\text{21}<X<\text{25})$
    \end{enumerate}
    \end{multicols}
    \item Given that random variable $X$ is normally distributed with mean 80 and standard deviation 4, find:
    \begin{multicols}{4}
    \begin{enumerate}
        \item $\text{P}(X>\text{83.1})$
        \item $\text{P}(X<\text{79.3})$
        \item $\text{P}(X>\text{72.7})$
        \item $\text{P}(\text{81}<X<\text{89})$
    \end{enumerate}
    \end{multicols}
...
\begin{itemize}
    ...
    \item Use the $z$-transformation.\\[0.1em]
    \item Solve for $x$.
\end{itemize}
...
\vspace{-0.5cm}
\begin{flalign*}
\text{P}(Z<z)=\text{0.9} & \rightarrow z=\text{1.28}&&\\
\frac{x-\text{280}}{\text{4}}&=\text{1.28}\\
x &= \text{1.28}\times \text{4} + \text{280}\hspace{1cm}
\begin{tikzpicture}[overlay]
\begin{axis}[
  no markers, 
  domain=-3:3, 
...
\begin{align*}
X\sim &\text{N}(\text{31},\text{4}^\text{2})\\
\text{P}(Z<z)=&\text{0.05} \rightarrow z=-\text{1.64} &\\
-\text{1.64}=&\frac{x-\text{31}}{\text{4}}\hspace{3cm}
\begin{tikzpicture}[overlay]
\begin{axis}[
  no markers, 
  domain=-3:3, 
...
\begin{align*}
X\sim & \text{N}(\text{6.8},\sigma^\text{2})\\
\text{P}(Z<z)=&\text{0.999} \rightarrow z=\text{3.09}\hspace{1cm}
\begin{tikzpicture}[overlay]
\begin{axis}[
  no markers, 
  domain=-3.2:3.2, 
...
\end{axis}
\end{tikzpicture}&\\
\text{3.09}=&\frac{\text{10}-\text{6.8}}{\sigma}\\
\text{3.09}\sigma=&\text{3.2}\\
\sigma=&\frac{\text{3.2}}{\text{3.09}}\\
\sigma=&\text{1.04}
\end{align*}
...
\begin{enumerate}
    \item Given each sketch of $Z\sim \text{N}(\text{0},\text{1})$ below, use page 12 of the Data Booklet to state the value of $z$:
    \begin{enumerate}
    \begin{multicols}{3}
        \item $\text{P}(Z<z)=\text{0.99}$\\
        \begin{tikzpicture}
\begin{axis}[
  no markers, 
  domain=-3:3, 
...
\addplot [draw=none, fill=Black!20, domain=-3:2.33] {gauss(x, 0, 1)} 
\closedcycle;
 \addplot [semithick] {gauss(x, 0, 1)};
\pgfmathsetmacro\valueA{gauss(2.33,0,1)}
\pgfmathsetmacro\valueB{gauss(0,0,1)}
\fill[Black!20] (axis cs: -3,-0.02) rectangle (axis cs: 2.33,0);
\draw [semithick, black]  (axis cs:2.33,-0.02) -- (axis cs:2.33,\valueA);
\node[below] at (axis cs: 2.33,0)  {$z$};
\node[above] at (axis cs: 0,\valueB)  {$Z$};
\node at (axis cs: 0,0.2)  {99\%};
\node[below] at (axis cs: 0,0)  {0};
\draw[semithick] (axis cs: -3,-0.02) -- (axis cs: 3,-0.02);
\end{axis}
\end{tikzpicture}
\item $\text{P}(Z<z)=\text{0.95}$\\
        \begin{tikzpicture}
\begin{axis}[
  no markers, 
  domain=-3:3, 
...
\addplot [draw=none, fill=Black!20, domain=-3:1.64] {gauss(x, 0, 1)} 
\closedcycle;
 \addplot [semithick] {gauss(x, 0, 1)};
\pgfmathsetmacro\valueA{gauss(1.64,0,1)}
\pgfmathsetmacro\valueB{gauss(0,0,1)}
\fill[Black!20] (axis cs: -3,-0.02) rectangle (axis cs: 1.64,0);
\draw [semithick, black]  (axis cs:1.64,-0.02) -- (axis cs:1.64,\valueA);
\node[below] at (axis cs: 1.64,0)  {$z$};
\node[above] at (axis cs: 0,\valueB)  {$Z$};
...
\addplot [draw=none, fill=Black!20, domain=-3:0.67] {gauss(x, 0, 1)} 
\closedcycle;
 \addplot [semithick] {gauss(x, 0, 1)};
\pgfmathsetmacro\valueA{gauss(0.67,0,1)}
\pgfmathsetmacro\valueB{gauss(0,0,1)}
\fill[Black!20] (axis cs: -3,-0.02) rectangle (axis cs: 0.67,0);
\draw [semithick, black]  (axis cs:0.67,-0.02) -- (axis cs:0.67,\valueA);
\node[below] at (axis cs: 0.67,0)  {$z$};
\node[above] at (axis cs: 0,\valueB)  {$Z$};
\node at (axis cs: 0,0.2)  {75\%};
\node[below] at (axis cs: 0,0)  {0};
\draw[semithick] (axis cs: -3,-0.02) -- (axis cs: 3,-0.02);
\end{axis}
\end{tikzpicture}
...
\addplot [draw=none, fill=Black!20, domain=-1.28:3] {gauss(x, 0, 1)} 
\closedcycle;
 \addplot [semithick] {gauss(x, 0, 1)};
\pgfmathsetmacro\valueA{gauss(-1.28,0,1)}
\pgfmathsetmacro\valueB{gauss(0,0,1)}
\fill[Black!20] (axis cs: -1.28,-0.02) rectangle (axis cs: 3,0);
\draw [semithick, black]  (axis cs:-1.28,-0.02) -- (axis cs:-1.28,\valueA);
\node[below] at (axis cs: -1.28,0)  {$z$};
\node[above] at (axis cs: 0,\valueB)  {$Z$};
...
\node[below] at (axis cs: 1.64,0)  {$z$};
\node[above] at (axis cs: 0,\valueB)  {$Z$};
\node at (axis cs: 2.2,0.2)  {10\%};
\node[below] at (axis cs: 0,0)  {0};
\draw[semithick] (axis cs: -3,-0.02) -- (axis cs: 3,-0.02);
\end{axis}
\end{tikzpicture}
\item $\text{P}(-z<Z<z)=\text{0.95}$\\
        \begin{tikzpicture}
\begin{axis}[
  no markers, 
  domain=-3:3, 
...
\draw [semithick, black]  (axis cs:1.96,-0.02) -- (axis cs:1.96,\valueA);
\draw [semithick, black]  (axis cs:-1.96,-0.02) -- (axis cs:-1.96,\valueA);
...
\end{tikzpicture}
    \end{multicols}
    \end{enumerate}
    \item Given $Z\sim \text{N}(\text{0},\text{1})$, use a sketch to find the value of $z$ if:
    \begin{multicols}{4}
    \begin{enumerate}
    \setlength{\itemsep}{0.5em}
        \item[(a)] $\text{P}(Z>z)=\text{0.1}$
        \item[(e)] $\text{P}(Z<z)=\text{0.995}$
        \item[(i)] $\text{P}(Z>z)=\text{0.975}$
        \item[(b)] $\text{P}(Z>z)=\text{0.05}$
        \item[(f)] $\text{P}(Z<z)=\text{0.025}$
        \item[(j)] $\text{P}(Z<z)=\text{0.999}$
        \item[(c)] $\text{P}(Z>z)=\text{0.001}$
        \item[(g)] $\text{P}(Z<z)=\text{0.005}$
        \item[(k)] $\text{P}(Z<z)=\text{0.791}$
        \item[(d)] $\text{P}(Z<z)=\text{0.99}$
        \item[(h)] $\text{P}(Z>z)=\text{0.9}$
        \item[(l)] $\text{P}(Z>z)=\text{0.003}$
    \end{enumerate}
    \end{multicols}
...
*Sums and differences* of independent and normally distributed random variables are *themselves normally distributed*, and the mean and variance of these may be determined using the laws of expectation and variance introduced in section 6.6. For example, given **independent** normally distributed random variables $X$ and $Y$ with means of $\mu_X$ and $\mu_Y$ and standard deviations of $\sigma_X$ and $\sigma_Y$ respectively:

$$X+Y\sim \text{N}(\mu_X+\mu_Y,\sigma_X^\text{2}+\sigma_Y^\text{2})\quad\text{   and   }\quad X-Y\sim \text{N}(\mu_X-\mu_Y,\sigma_X^\text{2}+\sigma_Y^\text{2})$$

Note that $\text{2}X$ is *not* the same thing as the sum of two independent observations of $X$, which can be expressed as $X_\text{1}+X_\text{2}$. They share the same expectation, but different variance. Given $X\sim \text{N}\left(\mu,\sigma^\text{2}\right)$:
...
\begin{align*}
    \text{E}(X_\text{1}+X_\text{2})&=\text{E}(X_\text{1})+\text{E}(X_\text{2})\\
    &=\text{2}\text{E}(X)\\[0.5em]
    \text{V}(X_\text{1}+X_\text{2})&=\text{V}(X_\text{1})+\text{V}(X_\text{2})\\
    &=\text{2}\text{V}(X)\\[0.5em]
\end{align*}
...
\begin{align*}
    \text{E}(\text{2}X)&=\text{2}\text{E}(X)\\
    &\phantom{=\text{2}\text{E}(X)}\\[0.5em]
    \text{V}(\text{2}X)&=\text{2}^\text{2}\times\text{V}(X)\\
    &=4\text{V}(X)\\[0.5em]
\end{align*}
...
The sum of $n$ independent observations of $X$ is $X_\text{1}+X_\text{2}+\dots+X_n$.

\vspace{-0.2cm}

\begin{align*}
\text{E}(X_\text{1}+X_\text{2}+...+X_n)=&\text{E}(X_\text{1})+\text{E}(X_\text{2})+\dots+\text{E}(X_n)=n\text{E}(X)\\[0.2em]
\text{V}(X_\text{1}+X_\text{2}+...+X_n)=&\text{V}(X_\text{1})+\text{V}(X_\text{2})+\dots+\text{V}(X_n)=n\text{V}(X)
\end{align*}
...
\begin{tcolorbox}[title=Example,colback=RoyalBlue!1!,colframe=RoyalBlue]
\textbf{Problem:} The actual volume of paint contained within tins marked as containing 25 litres is normally distributed with a mean of 25.2 litres and a standard deviation of 0.3 litres. Calculate the probability that the total volume in 8 tins is less than 200 litres, stating an assumption required
...
Let random variable $X\sim \text{N}(\text{25.2},\text{0.3}^\text{2})$ represent the volume of paint in a tin.\\[0.1em]

Let $T$ represent the total volume of paint in the eight tins.\\[0.1em]

Assuming the volume of paint in each tin is independent.\\[0.1em]

$T=X_\text{1}+X_\text{2}+\dots+X_\text{8}$\\[0.1em]

$\text{E}(T)=\text{8}\times\text{E}(X)=\text{8}\times\text{25.2}=\text{201.6}$\\[0.1em]

$\text{V}(T)=\text{8}\times\text{V}(X)=\text{8}\times\text{0.3}^\text{2}=\text{0.72}$\hspace{3cm}
...
\addplot [draw=none, fill=Black!20, domain=-3:-1.89] {gauss(x, 0, 1)} 
\closedcycle;
 \addplot [semithick] {gauss(x, 0, 1)};
\pgfmathsetmacro\valueA{gauss(-1.89,0,1)}
\pgfmathsetmacro\valueB{gauss(0,0,1)}
\fill[Black!20] (axis cs: -3,-0.02) rectangle (axis cs: -1.89,0);
\draw [semithick, black]  (axis cs:-1.89,-0.02) -- (axis cs:-1.89,\valueA);
\node[below] at (axis cs: -1.89,0)  {$-\text{1.89}$};
\node[above] at (axis cs: 0,\valueB)  {$Z$};
\node at (axis cs: -2.5,0.2)  {2.94\%};
\node[below] at (axis cs: 0,0)  {0};
\draw[semithick] (axis cs: -3,-0.02) -- (axis cs: 3,-0.02);
\end{axis}
\end{tikzpicture}\\[0.1em]

$T\sim \text{N}(\text{201.6},\text{0.72})$\\[0.1em]

$\text{P}(T<\text{200})=\text{P}\left(Z<\dfrac{\text{200}-\text{201.6}}{\sqrt{\text{0.72}}}\right)=\text{P}(Z<-\text{1.89})=\text{0.0294}$
\end{tcolorbox}
...
\begin{enumerate}
    \item The time taken for a chef to chop an onion is normally distributed with mean 19 seconds and standard deviation 3 seconds. Assuming the time taken to chop each onion is independent, calculate the probability that it takes over \textbf{one minute} in total for the chef to chop three onions.
    \item The mass of a library book in a school's library is normally distributed, with a mean of 400g and a standard deviation of 60g. Twenty books are selected at random to be placed on a table as part of a display.
    \begin{enumerate}
        \item Calculate the probability of the total mass of the 20 books being less than 8000g.
        \item State an assumption required, and explain why this assumption may be reasonable.
    \end{enumerate}
    \item A coffee machine has an option which dispenses a portion of milk. The volume of milk dispensed each time is normally distributed with mean 28ml and variance 3$\text{ml}^\text{2}$. Assuming that the volume of each portion is independent, determine the probability that the total volume of four portions exceeds 110ml.
    \item The mass of a \textit{house martin}, a species of bird, is normally distributed with mean 18g and variance 2$\text{g}^\text{2}$. Five house martins are observed perched together on a telephone line. Stating an assumption required, determine the probability that the total mass of the five birds is greater than 70g.
    \item Basketball games are played across four \textit{quarters}, each lasting ten minutes. Extensively collected data shows that the distance run by professional basketball players during a quarter follows a normal distribution with a mean of 1km and a variance of 0.1$\text{km}^\text{2}$. Give a reason why this does not necessarily imply that the total distance run by a player during a full game of four quarters can be modelled by a normal distribution with mean 4km and variance 0.4$\text{km}^\text{2}$.
...
\pgfplotsset{
    ...
    \end{axis}
\end{tikzpicture}
\captionof{figure}{$\text{B}(\text{8},\text{0.2})$}
  \label{fig:test1}
\end{center}
...
\pgfplotsset{
    ...
    \end{axis}
\end{tikzpicture}
\captionof{figure}{$\text{B}(\text{25},\text{0.4})$}
  \label{fig:binomapprox}
\end{center}
...
\addplot [fill=Black!20, fill opacity=0.5] {binom(x,60,0.5)}; 
\end{axis}
\end{tikzpicture}
\captionof{figure}{$\text{B}(\text{60},\text{0.5})$}
  \label{fig:test112bakusbd}
\end{center}
...
As the number of trials $n$ grows (and for probabilities of success closer to 0.5), the *discrete* binomial distribution can begin to resemble a *continuous* normal distribution. Given random variable $X\sim \text{B}(n,p)$, a *normal distribution* can approximate the binomial distribution, with *sufficient accuracy*, when:   

\begin{centering}
\tcbset{width=12cm}
\begin{tcolorbox}[adjusted title=Conditions for normal approximation to binomial distributions:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
\begin{center}
$np>\text{5}$\quad \text{ and } \quad $nq>\text{5}$
\end{center}
\end{tcolorbox}
\end{centering}
...
\[\text{If } X\sim \text{B}(n,p) \text{ then } X\approx \text{N}(np,npq)\]
...
\begin{tikzpicture}[xscale=0.8]
    \draw[fill=black!10] (-0.5,0) rectangle (0.5,10*0.00049);
    \draw[fill=black!10] (0.5,0) rectangle (1.5,10*0.00537);
    \draw[fill=black!10] (1.5,0) rectangle (2.5,10*0.02686);
    \draw[fill=black!10] (2.5,0) rectangle (3.5,10*0.08057);
    \draw[fill=black!10] (3.5,0) rectangle (4.5,10*0.16113);
    \draw[fill=black!10] (4.5,0) rectangle (5.5,10*0.22559);
    \draw[fill=black!10] (5.5,0) rectangle (6.5,10*0.22559);
    \draw (6.5,0) rectangle (7.5,10*0.16113);
    \draw (7.5,0) rectangle (8.5,10*0.08057);
    \draw (8.5,0) rectangle (9.5,10*0.02686);
    \draw (9.5,0) rectangle (10.5,10*0.00537);
    \draw (10.5,0) rectangle (11.5,10*0.00049);    
    \draw[very thick,domain=-3:3,smooth,samples=50,yscale=10/1.658,xshift=5.5cm,xscale=1.658] plot (\x,{1/((2*3.14)^0.5)) * 2.718^(-0.5*(\x)^2)}) -- (1.3,0);
    \foreach \x in {0,1,...,11}{
    \draw (\x,0) -- (\x,-0.1) node[below] {\x};
    }
    \node at (5.5,-1.5) {$\text{P}(X<\text{7})=\text{P}\left(Z<\dfrac{\text{6}+\text{0.5}-\text{5.5}}{\sqrt{\text{2.75}}}\right)$};
\end{tikzpicture}
\end{center}
...
\begin{center}
    \begin{tabular}{|c|c|}
        ...
        \hline
        $\text{P}(X=\text{7})$ & $\text{P}(\text{6.5}<X<\text{7.5})$\\
        \hline
        $\text{P}(X<\text{7})$ & $\text{P}(X<\text{6.5})$\\
        \hline
        $\text{P}(X\leqslant \text{7})$ & $\text{P}(X<\text{7.5})$\\
        \hline
        $\text{P}(X>\text{7})$ & $\text{P}(X>\text{7.5})$\\
        \hline
        $\text{P}(X\geqslant \text{7})$ & $\text{P}(X>\text{6.5})$\\
        \hline
    \end{tabular}
\end{center}
...
When calculating the discrete probability $\text{P}(X<\text{7})$, the bar representing the discrete integer 7 should not be included. The continuous probability $\text{P}(X<\text{6.5})$, making a **continuity correction**, would provide a more accurate estimate of the desired probability. For the discrete probability $\text{P}(X\leqslant \text{7})$, where the discrete integer value of 7 should be included, the continuous probability $\text{P}(X<\text{7.5})$ would be more accurate.

\pagebreak

\begin{tcolorbox}[title=Example,colback=RoyalBlue!1!,colframe=RoyalBlue]
\textbf{Problem:} A quiz contains 40 multiple choice questions, with four answers for every question. If a pupil picks answers entirely at random, use a suitable approximation to calculate the probability that they get at least half correct, justifying the suitability of the approximation used.  
...
$X\sim \text{B}(\text{40},\text{0.25})$\\

$np=\text{40}\times \text{0.25}=\text{10}$, $nq=\text{40}\times \text{0.75}=\text{30}$\\

$np>\text{5}$ and $nq>\text{5}$ therefore a normal approximation is appropriate.\\

$\text{E}(X)=np=\text{10}$\\

$\text{V}(X)=npq=\text{40}\times \text{0.25} \times \text{0.75}=\text{7.5}$\\

$X\approx \text{N}(\text{10},\text{7.5})$\hspace{6.5cm}
\begin{tikzpicture}[remember picture, overlay]
\begin{axis}[
  no markers, 
  domain=-4:4, 
...
\addplot [draw=none, fill=Black!20, domain=3.47:4] {gauss(x, 0, 1)} 
\closedcycle;
 \addplot [semithick] {gauss(x, 0, 1)};
\pgfmathsetmacro\valueA{gauss(3.47,0,1)}
\pgfmathsetmacro\valueB{gauss(0,0,1)}
\fill[Black!20] (axis cs: 3.47,-0.02) rectangle (axis cs: 4,0);
\draw [semithick, black]  (axis cs:3.47,-0.02) -- (axis cs:3.47,\valueA);
\node[below] at (axis cs: 3.47,0)  {3.47};
\node[above] at (axis cs: 0,\valueB)  {$Z$};
\node at (axis cs: 3.8,0.1)  {0.03\%};
\node[below] at (axis cs: 0,0)  {0};
\draw[semithick] (axis cs: -4,-0.02) -- (axis cs: 4,-0.02);
\end{axis}
\end{tikzpicture}\\

$\text{P}(X\geqslant \text{20})=\text{P}\left(Z>\dfrac{\text{19.5}-\text{10}}{\sqrt{\text{7.5}}}\right)
= \text{P}(Z>\text{3.47})
= \text{0.0003}$
...
\begin{enumerate}[itemsep=0pt]
    \item Given $X\sim \text{B}(\text{40},\text{0.4})$:
    \begin{enumerate}[itemsep=0pt]
        \item Show that a normal approximation is appropriate.
        \item Find:
        \begin{multicols}{3}
        \begin{enumerate}
            \item $\text{P}(X\leqslant\text{20})$
            \item $\text{P}(\text{25}\leqslant X\leqslant\text{28})$
            \item $\text{P}(X>\text{31})$
        \end{enumerate}
        \end{multicols}
    \end{enumerate}
    \item Given $Y\sim \text{B}\left(\text{81},\frac{\text{2}}{\text{3}}\right)$:
    \begin{enumerate}[itemsep=0pt]
        \item Show that a normal approximation is appropriate.
        \item Find:
        \begin{multicols}{3}
        \begin{enumerate}
            \item $\text{P}(Y\geqslant\text{56})$
            \item $\text{P}(Y=\text{48})$
            \item $\text{P}(\text{50}<Y<\text{60})$
        \end{enumerate}
        \end{multicols}
    \end{enumerate}
...
\pgfplotsset{
    ...
    \end{axis}
\end{tikzpicture}
\captionof{figure}{$\text{Po}(\text{1.5})$}
  \label{fig:test1sada}
\end{center}
...
\addplot [fill=Black!20, fill opacity=0.5] {pois(x,8)}; 
\end{axis}
\end{tikzpicture}
\captionof{figure}{$\text{Po}(\text{8})$}
  \label{fig:test1}
\end{center}
...
\addplot [fill=Black!20, fill opacity=0.5] {pois(x,25)}; 
\end{axis}
\end{tikzpicture}
\captionof{figure}{$\text{Po}(\text{25})$}
  \label{fig:test1}
\end{center}
...
As with the binomial distribution, the *discrete* Poisson distribution can also begin to resemble a *continuous* normal distribution; it will do so when it becomes closer to symmetrical as $\lambda$ increases. Given the random variable $X\sim \text{Po}(\lambda)$, a normal distribution can *approximate* the Poisson distribution with sufficient accuracy when:   

\begin{centering}
\tcbset{width=12cm}
\begin{tcolorbox}[adjusted title=Conditions for normal approximation to Poisson distributions:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
\begin{center}
$\lambda>\text{10}$
\end{center}
\end{tcolorbox}
...
$$\text{If } X\sim \text{Po}(\lambda) \text{ then } X\approx \text{N}(\lambda,\lambda)$$
...
Let random variable $T$ represent the number of goals across the 10 games, with $\lambda=\text{2.5}\times \text{10}=\text{25}$.\\

$T\sim \text{Po}(\text{25})$\\

Since $\lambda>\text{10}$, a normal approximation is appropriate.\\

$\text{E}(T)=\text{V}(T)=\text{25}$\\

$T\approx \text{N}(\text{25},\text{25})$

\vspace{-0.3cm}

\begin{flalign*}
\text{P}(\text{15}\leqslant T \leqslant \text{20})= &\text{P}\left(\frac{\text{14.5}-\text{25}}{\sqrt{\text{25}}}<Z<\frac{\text{20.5}-\text{25}}{\sqrt{\text{25}}}\right)\hspace{1.5cm}
\begin{tikzpicture}[remember picture, overlay]
\begin{axis}[
  no markers, 
  domain=-3:3, 
...
\addplot [draw=none, fill=Black!20, domain=-2.1:-0.9] {gauss(x, 0, 1)} 
\closedcycle;
 \addplot [semithick] {gauss(x, 0, 1)};
\pgfmathsetmacro\valueA{gauss(-2.1,0,1)}
\pgfmathsetmacro\valueC{gauss(-0.9,0,1)}
\pgfmathsetmacro\valueB{gauss(0,0,1)}
\fill[Black!20] (axis cs: -2.1,-0.02) rectangle (axis cs: -0.9,0);
\draw [semithick, black]  (axis cs:-2.1,-0.02) -- (axis cs:-2.1,\valueA);
\draw [semithick, black]  (axis cs:-0.9,-0.02) -- (axis cs:-0.9,\valueC);
\draw[dashed] (axis cs: -0.9,-0.01) -- (axis cs: -0.9,-0.09);
\node[below] at (axis cs: -0.9,-0.1)  {$-\text{0.9}$};
\node[below] at (axis cs: -2.1,0)  {$-\text{2.1}$};
\node[above] at (axis cs: 0,\valueB)  {$Z$};
\node at (axis cs: -2.2,0.2)  {16.62\%};
\node[below] at (axis cs: 0,0)  {0};
\draw[semithick] (axis cs: -3,-0.02) -- (axis cs: 3,-0.02);
\end{axis}
\end{tikzpicture}&\\[0.2em]
= &\text{P}(-\text{2.1}<Z<-\text{0.9})\\[0.2em]
= &\text{P}(Z<-\text{0.9})-\text{P}(Z<-\text{2.1})\\[0.2em]
= &\text{0.1841}-\text{0.0179}\\[0.2em]
= &\text{0.1662}
\end{flalign*}
...
\begin{enumerate}
    \item Given $X\sim \text{Po}(\text{24})$, use the normal approximation to find:
    \begin{multicols}{3}
    \begin{enumerate}
        \item $\text{P}(X\leqslant\text{25})$
        \item $\text{P}(X=\text{21})$
        \item $\text{P}(X>\text{23})$
    \end{enumerate}
    \end{multicols}
    \item Given $X\sim \text{Po}(\text{60})$, use the normal approximation to find:
    \begin{multicols}{3}
    \begin{enumerate}
        \item $\text{P}(X\geqslant\text{57})$
        \item $\text{P}(\text{50}< X \leqslant \text{56})$
        \item $\text{P}(\text{62}<X<\text{66})$
    \end{enumerate}
    \end{multicols}
...
\begin{enumerate}[itemsep=10pt]
    \item Given $X\sim \text{U}(\text{1,7})$, find:
    \begin{enumerate}
        \item $\text{E}(X)$
        \item $\text{V}(\text{3}-X)$
        \item $\text{P}(X<\text{3})$
    \end{enumerate}
    \item Given $X\sim \text{N}(\text{20},\text{6})$, find:
    \begin{enumerate}
        \item $\text{P}(X<\text{25})$
        \item $\text{P}(\text{14}<X<\text{20})$
    \end{enumerate}
    ...
    \end{enumerate}
    \item For continuous random variable $X\sim \text{N}\left(\mu,\text{3}^\text{2}\right)$, $\text{P}(X<\text{16})=\text{0.1}$. Determine the value of $\mu$ for $X$. 
