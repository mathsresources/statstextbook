...
\begin{center}
\begin{tabular}{ccc}
     & \textit{The coin, die and number generator are all fair,}& \\
     & \textit{and a very unlikely event simply happened by random chance...} & \\
     && \\
     & \textbf{or} & \\
     && \\
...
\begin{enumerate}
    \item[(a)] The mean volume of liquid in espressos sold by a café is less than the 30ml stated on their menu. 
...
\begin{enumerate}
    \begin{multicols}{2}
    \item[(a)] $\text{H}_\text{0}:$  $\mu=\text{30}$ \quad \textnormal{  One-tailed.}\\ $\text{H}_\text{1}:$  $\mu<\text{30}$
    \item[(b)] $\text{H}_\text{0}:$  $\mu=\text{240}$ \quad \textnormal{Two-tailed.}\\ $\text{H}_\text{1}:$  $\mu\ne\text{240}$
    \end{multicols}
\end{enumerate}
\end{tcolorbox}
...
The probability of observing a result at least as extreme as the one obtained, assuming the null hypothesis is true and in the direction specified by the alternative hypothesis, is called the $\mathbf{p}$\textbf{-value}. A decision should be made in advance of collecting the data regarding the **significance level**, $\alpha$ (*"alpha"*). A significance level of 5\% ($\alpha=\text{0.05}$) is commonand is often used when no other significance level has been specified. It can be interpreted as the level of 'unlikeliness' that it would take in order to abandon $\text{H}_\text{0}$ in favour of $\text{H}_\text{1}$.
...
\begin{centering}
\tcbset{width=16cm}
\begin{tcolorbox}[adjusted title=The decision rule for the $p$-value and the significance level $\alpha$:, halign title = center,colback=red!5,colframe=red!70!black, halign = center,center]
\centering
...
Failing to reject the null hypothesis does not prove that it is true; it simply indicates that there is insufficient evidence against it. To avoid suggesting that evidence will ever be found for the null hypothesis, the phrase 'accept $\text{H}_\text{0}$' should **not be used**.
...
\begin{itemize}
    \item The \textit{sampling distribution of the sample mean} is \textbf{normal} (or approximately normal)
...
Probabilities relating to observed sample means have already been covered in Chapter 9, and the following examples will demonstrate how this leads to a calculated $p$-value for a hypothesis test based on a sample mean. Note below that, with a sample mean of 257 observed, and an alternative hypothesis that the true population mean is *less than* 260, the $p$-value is the probability of observing a sample mean *as extreme or more extreme* than 257. In the context of a claim that $\mu<\text{260}$, the $p$-value is therefore $\text{P}\left(\bar{X}<\text{257}\right)$.
...
\tcblower
\textbf{Solution:}
$\mu=\text{260}$, $\bar{x}=\text{257}$, $n=\text{14}$, $\sigma=\text{10}$\\
...
\begin{math}
\begin{array}{ll}
      \text{H}_\text{0}: & \mu=\text{260}\\
      \text{H}_\text{1}: & \mu<\text{260}
    \end{array}
\end{math}
...
\node[below] at (axis cs:-1.12,0)  {$-\text{1.12}$};
...
$P(\bar{X}<\text{257})=P\left(Z<\dfrac{\text{257}-\text{260}}{\frac{\text{10}}{\sqrt{\text{14}}}}\right)=P(Z<-\text{1.12})=\text{0.1314}$\\

\vspace{0.1cm}

Since $\text{0.1314}>\text{0.01}$, do not reject $\text{H}_\text{0}$ at the 1\% level of significance. There is insufficient evidence to suggest that the mean distance the car can cover on a full charge is less than the stated 260 miles, and so no evidence to support the car magazine's claim.
...
\tcblower
\textbf{Solution:}
$\mu=\text{150}$, $\bar{x}=\text{150.8}$, $n=\text{30}$, $\sigma=\text{2}$\\

\vspace{0.01cm}

\begin{math}
\begin{array}{ll}
      \text{H}_\text{0}: & \mu=\text{150}\\
      \text{H}_\text{1}: & \mu>\text{150}
    \end{array}
\end{math}
...
$P(\bar{X}>\text{150.8})=P\left(Z>\dfrac{\text{150.8}-\text{150}}{\frac{\text{2}}{\sqrt{\text{30}}}}\right)=P(Z>\text{2.19})=\text{0.0143}$\\[0.2em]

Since $\text{0.0143}<\text{0.05}$, reject $\text{H}_\text{0}$ at the 5\% level of significance. There is sufficient evidence to suggest that the mean mass of crisps dispensed per bag is more than 150g.
...
\tcblower
\textbf{Solution:}
$\mu=\text{82}$, $\bar{x}=\text{83}$, $n=\text{36}$, $\sigma\approx \text{3}$\\

\vspace{0.01cm}

Assume that the sample of tomatoes was random. Since $n>\text{20}$, the distribution of the sample mean is approximately normally distributed regardless of the underlying distribution of the mass of a tomato.\\

\vspace{0.3cm}
\begin{math}
\begin{array}{ll}
      \text{H}_\text{0}: & \mu=\text{82}\\
      \text{H}_\text{1}: & \mu\ne \text{82}
    \end{array}
\end{math}
...
\node[below] at (axis cs:-2,0)  {$-\text{2}$};
\node[above] at (axis cs: 0,\valueB)  {$Z$};
\node[below] at (axis cs: 0,0)  {0};
...
$P(\bar{X}>\text{83})=P\left(Z>\dfrac{\text{83}-\text{82}}{\frac{\text{3}}{\sqrt{\text{36}}}}\right)=P(Z>\text{2})=\text{0.0228}$\\

\vspace{0.1cm}

$p$-value $=\text{2} \times \text{0.0228} = \text{0.0456}$ and $\alpha=\text{0.05}$\\[0.2em]

Since $\text{0.0456}<\text{0.05}$, reject $\text{H}_\text{0}$ at the 5\% level of significance. There is sufficient evidence to suggest that the mean mass of the grower's tomatoes has changed from 82 grams.
...
\begin{math}
\begin{array}{ll}
      \text{H}_\text{0}: & \text{mean}=\text{2.5}\\
      \text{H}_\text{1}: & \text{mean}< \text{2.5}
    \end{array}
\end{math}\\
...
\node[below] at (axis cs:-0.5,0)  {$-\text{0.5}$};
\node[above] at (axis cs: 0,\valueB)  {$Z$};
...
$\text{P}(\bar{X}<\text{2.3})=\text{0.3085}$\\

$p\text{-value}=\text{0.3085}$\\

Since $\text{0.3085}>\text{0.05}$, accept $\text{H}_\text{0}$ at the 5\% level of significance. There is insufficient evidence to suggest that the mass of dried tea leaves in a bag is less than 2.5 grams.
...
\begin{enumerate}[resume]
    ...
    \item The figure often quoted as the mean time spent with the ball being in play during a game of football is 58 minutes, with the standard deviation being 4 minutes, and it is assumed that the time for which the ball is in play is normally distributed. A sports statistician is planning a hypothesis test to assess the evidence that the mean time during which the ball is in play has changed from 58 minutes. A random sample of 15 games gives a mean time in play of 61 minutes.\\[0.5em] A $z$-test is to be used to assess the data.
    \begin{enumerate}
...
\node[below] at (axis cs: -1.64, 0) {$-\text{1.64}$};
...
\node[below] at (axis cs: 0,0)  {0};
\node[above] at (axis cs: 0,\valueB)  {$\text{H}_\text{1}: \mu\ne...$};
\node[below] at (axis cs: -1.96, 0) {$-\text{1.96}$};
...
\node[above] at (axis cs: 0,0.42) {Test statistic: $z=-\text{2.01}$};
\node[below] at (axis cs: 0,-0.2) {$-\text{2.01}<-\text{1.64}$};
...
\node[above] at (axis cs: 0,0.42) {Test statistic: $z=-\text{0.92}$};
\node[below] at (axis cs: 0,-0.2) {$-\text{0.92}>-\text{1.96}$};
...
\node[above] at (axis cs: 0,0.42) {Test statistic: $z=\text{1.43}$};
\node[below] at (axis cs: 0,-0.2) {$\text{1.43}<\text{1.64}$};
\node[below] at (axis cs: 0,-0.35) {do not reject $\text{H}_\text{0}$};
\end{axis}
\end{tikzpicture}
\end{minipage}
...
Test statistic: $z=\dfrac{\text{257}-\text{260}}{\dfrac{\text{10}}{\sqrt{\text{14}}}}=-\text{1.12}$
\hspace{4cm}
...
\node[below] at (axis cs: 0,0)  {0}; 
\node[below] at (axis cs: -2.33, 0) {$-\text{2.33}$};
\draw[very thick] (axis cs: -1.12,0) -- (axis cs: -1.12,0.44) node[above] {$-\text{1.12}$};
...
Critical value: $z=-\text{2.33}$\\

Since $-\text{1.12}>-\text{2.33}$, do not reject $\text{H}_\text{0}$ at the 1\% level of significance. There is insufficient evidence to suggest that the mean distance the car can cover on a full charge is less than the stated 260 miles, and so no evidence to support the car magazine's claim.
...
Test statistic: $z=\dfrac{\text{83}-\text{82}}{\dfrac{\text{3}}{\sqrt{\text{36}}}}=\text{2}$
\hspace{4cm}
\begin{tikzpicture}[overlay]
\begin{axis}[
  no markers, 
...
Critical value: $z=\text{1.96}$\\

Since $\text{2}>\text{1.96}$, reject $\text{H}_\text{0}$ at the 5\% level of significance. There is sufficient evidence to suggest that the mean mass of the grower's tomatoes has changed from 82 grams.
...
\end{axis}
\end{tikzpicture}
\captionof{figure}{$t$-distribution, $t_{\text{1}}$, and normal distribution, $z$}
  \label{fig:test1}
\end{minipage}%
  \centering
\begin{minipage}[t]{.5\textwidth}
...
\node[below] at (axis cs: 0,0.31)  {$\mathbf{t_\text{1}}$};
\node[above] at (axis cs: 0,0.4)  {$\mathbf{t_{\text{18}}}$};
\node[below] at (axis cs: 0,0)  {0};
\end{axis}
\end{tikzpicture}
\captionof{figure}{$t$-distributions with $\nu=\text{1}, \text{2}, \text{5},\text{18}$}
  \label{fig:test1}
\end{minipage}
\end{figure}
...
Stating a required assumption, perform a parametric test to assess the claim at the $\alpha=\text{0.01}$ level.

\tcblower
\textbf{Solution:}
$\mu=\text{150}$, $\bar{x}=\text{149}$, $n=\text{8}$, $s=\text{2.51}$\quad (calculating $\bar{x}$ and $s$ from the sample)\\
...
Test statistic: $t=\dfrac{\text{149}-\text{150}}{\dfrac{\text{2.51}}{\sqrt{\text{8}}}}=-\text{1.127}$
\hspace{3cm}
\begin{tikzpicture}[overlay]
\begin{axis}[
  no markers, 
...
\node[above] at (axis cs: 0,\valueB)  {$t_\text{7}$};
\node[below] at (axis cs: -2.8, -0.04) {$-\text{2.898}$};
\node[above] at (axis cs: -3,\valueA) {1\%};
\draw[very thick] (axis cs: -1.127,-0.04) -- (axis cs: -1.127,0.47) node[above] {$-\text{1.127}$};
\end{axis}
\end{tikzpicture}\\

Degrees of freedom: $\nu=n-\text{1}=\text{8}-\text{1}=\text{7}$\\

Critical value: $t=-\text{2.898}$\\

Since $-\text{1.127}>-\text{2.898}$, do not reject $\text{H}_\text{0}$ at the 1\% level of significance. There is insufficient evidence to suggest that the mean mass of crisps in a bag is less than the stated value of 150g.
...
\begin{center}
$\Sigma x=\text{571} \qquad \qquad \Sigma x^\text{2}=\text{46851} \qquad \qquad n=\text{7}$
\end{center}

\tcblower
\textbf{Solution:}
$\mu=\text{72}$, $\bar{x}=\text{81.57}$, $n=\text{7}$, $s=\text{6.754}$\\

\begin{math}
\begin{array}{ll}
      \text{H}_\text{0}: & \mu=\text{72}\\
      \text{H}_\text{1}: & \mu\ne \text{72}
    \end{array}
\end{math}
...
Test statistic: $t=\dfrac{\text{81.57}-\text{72}}{\dfrac{\text{6.754}}{\sqrt{\text{7}}}}=\text{3.749}$
\hspace{3cm}
\begin{tikzpicture}[overlay]
\begin{axis}[
  no markers, 
...
\node[below] at (axis cs: -2.9, -0.04) {$-\text{2.447}$};
\node[above] at (axis cs: -2.9,\valueA) {2.5\%};
\node[below] at (axis cs: 2.9, -0.04) {$\text{2.447}$};
\node[above] at (axis cs: 2.9,\valueA) {2.5\%};
\draw[very thick] (axis cs: 3.749,-0.04) -- (axis cs: 3.749,0.47) node[above] {$\text{3.749}$};
\draw (axis cs: -4,-0.04) -- (axis cs: 4,-0.04);
\end{axis}
\end{tikzpicture}\\

Degrees of freedom: $\nu=n-\text{1}=\text{7}-\text{1}=\text{6}$\\

Critical value: $t=\text{2.447}$\\

Since $\text{3.749}>\text{2.447}$, reject $\text{H}_\text{0}$ at the 5\% level of significance. There is sufficient evidence to suggest that the mean mark achieved by students is no longer 72, and that the difficulty of the exam has changed.
...
\begin{enumerate}
    ...
    \begin{center}
    \begin{tabular}{c c c} 
      $n=\text{10}$ & $\Sigma x=\text{40.5}$ & $\Sigma x^\text{2}=\text{165.49}$\\ 
    \end{tabular}
    \end{center}
    ...
    \begin{center}
    $\Sigma x=\text{34.89} \qquad \qquad \Sigma x^\text{2}=\text{110.81}$
    \end{center}
...
It has historically been observed that the mean mass of a chick after six weeks is 260 grams. Stating one assumption required, perform a hypothesis test to determine whether there is evidence at the 5\% level of significance that giving a soybean-based supplement affects the mass a chick will reach by six weeks.
    ...
    \end{enumerate}
    \item An experiment into the cold tolerance of a species of grass plant looked at the effect of low temperature on its carbon dioxide (CO2) uptake. It is known that, under normal conditions, the CO2 uptake rate for the species is known to be 33 $\mu mol/m^\text{2}$, whilst the sample of 7 areas exposed to chilling resulted in a sample mean uptake of 29.97 $\mu mol/m^\text{2}$ and a standard deviation of 8.335 $\mu mol/m^\text{2}$. Perform a parametric test to assess the evidence for CO2 uptake being affected by low temperature for the grass plant, at the 10\% level of significance.
\end{enumerate}
...
$$\mathsf{E}\left(\hat{P}\right)=\text{E}\left(\frac{X}{n}\right)=\frac{\text{1}}{n}\text{E}(X)=\frac{\text{1}}{n}\times np=p$$

$$\text{V}\left(\hat{P}\right)=\text{V}\left(\frac{X}{n}\right)=\left(\frac{1}{n}\right)^\text{2} \text{V}(X)=\frac{\text{1}}{n^\text{2}}\times npq=\frac{pq}{n}$$
Therefore:
...
\begin{itemize}
    \item $\mathbf{\textbf{\emph{np}}>\text{5}}$ \textbf{ and } $\mathbf{\textbf{\emph{nq}}>\text{5}}$
    \item The observations are \textbf{independent} (typically assured through \textit{random sampling}).
\end{itemize}
\end{tcolorbox}
\end{centering}
...
\tcblower
\textbf{Solution:}
$p=\text{0.1}$ , $q=\text{0.9}$ , $n=\text{60}$ , $\hat{p}=\frac{\text{11}}{\text{60}}=\text{0.183}$\\

\vspace{0.2cm}

\begin{math}
\begin{array}{ll}
      \text{H}_\text{0}: & p=\text{0.1}\\
      \text{H}_\text{1}: & p>\text{0.1}
    \end{array}
\end{math}\\

\vspace{0.2cm}

Test statistic: $z=\dfrac{\text{0.183}-\text{0.1}}{\sqrt{\dfrac{\text{0.1} \times \text{0.9}}{\text{60}}}}=\text{2.14}$
\hspace{3cm}
\begin{tikzpicture}[overlay]
\begin{axis}[
  no markers, 
...
Critical value: $z=\text{1.64}$\\


Since $\text{2.14}>\text{1.64}$, reject $\text{H}_\text{0}$ at the 5\% level of significance. There is sufficient evidence to suggest that the proportion of the new hard drives that fail within their first year of use is higher than 10\%.
...
\tcblower
\textbf{Solution:}
$p=\text{0.85}$ , $q=\text{0.15}$ , $n=\text{80}$ , $\hat{p}=\frac{\text{59}}{\text{80}}=\text{0.7375}$\\

$np=\text{80}\times \text{0.85}=\text{68}$ and $nq=\text{80}\times \text{0.15}=\text{12}$.

Since $np>\text{5}$ and $nq>\text{5}$, a normal approximation is appropriate.\\

\vspace{0.2cm}

\begin{math}
\begin{array}{ll}
      \text{H}_\text{0}: & p=\text{0.85}\\
      \text{H}_\text{1}: & p\ne \text{0.85}
    \end{array}
\end{math}\\
...
Test statistic: $z=\dfrac{\text{0.7375}-\text{0.85}}{\sqrt{\dfrac{\text{0.85} \times \text{0.15}}{\text{80}}}}=-\text{2.82}$
\hspace{3cm}
\begin{tikzpicture}[overlay]
\begin{axis}[
  no markers, 
...
\node[above] at (axis cs: 3.2,\valueA) {0.5\%};
\node[below] at (axis cs: -2.58, 0) {$-\text{2.58}$};
\node[above] at (axis cs: -3.2,\valueA) {0.5\%};
\draw[very thick] (axis cs: -2.82,0) -- (axis cs: -2.82,0.44) node[above] {$-\text{2.82}$};
\end{axis}
\end{tikzpicture}\\


Critical value: $z=-\text{2.58}$\\


Since $-\text{2.82}<-\text{2.58}$, reject $\text{H}_\text{0}$ at the 1\% level of significance. There is sufficient evidence to suggest that the true proportion of voters intending to vote for that candidate is not 85\%, and that the candidate's claim may be untrue.
...
\begin{enumerate}
    ...
    \begin{center}
        \begin{math}
          \begin{array}{ll}
            \text{H}_\text{0}: & p=\text{0.6}\\
            \text{H}_\text{1}: & p>\text{0.6}
          \end{array}
      \end{math}
    \end{center}
...
\begin{enumerate}
    ...
    \begin{center}
    \begin{tabular}{c c c} 
      $n=\text{8}$ & $\Sigma x=\text{1372}$ & $\Sigma x^\text{2}=\text{237466}$\\ 
    \end{tabular}
    \end{center}
    \begin{enumerate}
