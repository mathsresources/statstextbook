...
\begin{centering}
\tcbset{width=14cm}
\begin{tcolorbox}[adjusted title=Conditions for valid use of the one-sample $z$-test for the population mean:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
\begin{itemize}
...
\begin{centering}
\tcbset{width=14cm}
\begin{tcolorbox}[adjusted title=Conditions for valid use of the one-sample t-test for the population mean:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
\begin{itemize}
...
\begin{centering}
\tcbset{width=14cm}
\begin{tcolorbox}[adjusted title=Conditions for valid use of the one-sample z-test for the population proportion:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
\begin{itemize}
