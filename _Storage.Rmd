...
The strength of alcohol is measured as percentage alcohol by volume, or \%\text{ABV}). As whisky matures in casks, it increases in alcoholic strength, whilst subject to natural variation due to a variety of factors. A Scottish whiskey manufacturer sells \text{cask strength} whisky knows that in it's main warehouse the \% ABV of the whisky matured in each cask after a set time is normally distibuted with a mean of 58\% and a standard deviation of 3\%. It uses an $x$-bar chart to monitor 
