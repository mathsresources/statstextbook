...
\node[anchor=west] at (4,2) {median $=168.9$};
...
\begin{enumerate}
    \item A survey is carried out on the pets owned by a class. State whether the data collected would be qualitative or quantitative.
    \vspace{-0.5cm}
    \begin{enumerate}
    \begin{multicols}{2}
