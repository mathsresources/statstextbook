...
Samples statistics vary based on the sample chosen, and may be seen as \textit{estimates} of the true value of their respective population parameters, which are seen as fixed values (for a given study, at least). 
...
The reason for discussing sampling at this point is to caution against making any *definitive-sounding* statements based on *sample statistics*, when it is typically the (unknown) *population parameters* that are really of interest.
