...
The *lower quartile* (LQ or $\text{Q}_1$) and the *upper quartile* (UQ or $\text{Q}_3$) split data into quarters, along with the median. From the lowest value to $\text{Q}_1$ contains approximately 25\% of the data, from $\text{Q}_1$ to $\text{Q}_2$ contains approximtely the next 25\%, and so on.
...
\node[text width = 8cm,below] at (8,4) {Box plots offer a visual representation of a five-number summary, consisting of the minimum value, the lower quartile $\text{Q}_1$, the median, the upper quartile $\text{Q}_3$ and the maximum value.};
\draw[white] (3.5,-2) rectangle (12.5,5);
\end{tikzpicture}
