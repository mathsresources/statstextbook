...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \end{multicols}
    \end{enumerate}
    \item Categorical: \textit{activity level}, \textit{smoker}. Continuous: \textit{height}, \textit{mass}. Discrete: \textit{visits}. \textit{Pulse} could be argued to be discrete or continuous.
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item If the lengths of their stays were incorrectly recorded in the hospital's records, it would be valid to remove them from the dataset before conducting any further analysis. \textit{Other valid reasons are possible.}
    \end{enumerate}
        \end{multicols}
\end{enumerate}
...
\begin{enumerate}
    \item The population of hazelnuts masses appear to possibly follow a positively skewed distribution.
    \item The population of tree heights appear to possibly follow a symmetrical distributed (such as a normally distribution).
    \item The population of waiting times appear to be possibly uniformly distributed.
    \item The population of number of successful passes appears to possibly follow a bimodal distribution.
\end{enumerate}
