...
\begin{multicols}{2}
\begin{enumerate}
    \item $15.98 > 2.086$ so reject $\text{H}_0$
    \item $1.037 < 1.895$ so do not reject $\text{H}_0$
    \item $0.227 < 2.132$ so do not reject $\text{H}_0$
    \item $10.11 > 4.604$ so reject $\text{H}_0$
\end{enumerate}
\end{multicols}
...
\begin{enumerate}
    ...
    \begin{enumerate}
    \begin{multicols}{3}
    \item $\text{Context 1}: 95.3\%$
    \item $\text{Context 2}: 92.7\%$
    \item $\text{Context 3}: 57.5\%$
    \end{multicols}
    \end{enumerate}
    \begin{enumerate}[resume]
    \begin{multicols}{3}
    \item $\text{Context 4}: 13.3\%$
    \item $\text{Context 5}: 99\%$
    \end{multicols}
    \end{enumerate}
    \item
    \begin{enumerate}
...
\begin{enumerate}
    \begin{multicols}{3}
    \item $\hat{X}=−33.455+196.15y$\newline $\text{time in solutio}= 378.4$
    \item $\hat{X}=247.91+0.46y$\newline $\text{calorie}= 263.7$
    \item $\hat{X}=95.95+1.86y$\newline $\text{systolic b}= 116.44$
    \end{multicols}
\end{enumerate}
\begin{enumerate}[resume]
    \begin{multicols}{3}
    \item $\hat{X}=23.69+0.549y$\newline $\text{maths mar}= 64.92$
    \item $\hat{X}=18.86−0.62y$\newline $\text{weed killer concentratio}= 13.86$
    \end{multicols}
\end{enumerate}
...
\begin{enumerate}
    ...
    \item The residual plot appears to show the points centred on zero ($\text{E}(\epsilon)=0$) in a funnel pattern with decreasing variance ($\text{V}(\epsilon)\ne\sigma^2$) which suggests that the linear regression model is not suitable.
    \item The residual plot appears to show the points in the pattern of a U-shaped curve ($\text{E}(\epsilon)\ne0$) with constant variance ($\text{V}(\epsilon)=\sigma^2$) which suggests that the linear regression model is not suitable.
    \item The residual plot appears to show the points centred on zero ($\text{E}(\epsilon)=0$) in a funnel pattern with increasing variance ($\text{V}(\epsilon)\ne\sigma^2$) which suggests that the linear regression model is not suitable.
...
\begin{enumerate}
    ...
    \item The residual plot appears to show a random scatter of points centred on zero with constant variance so a linear model would be suitable for the data.
