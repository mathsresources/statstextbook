...
\begin{enumerate}
    \begin{multicols}{3}
    \item $\text{residual} = 1.4 – 1.215 = 0.185$
    \item $\text{residual} = 61 – 68 = -7$
    \item $\text{residual} =16 – 12.48 = 3.52$
    \end{multicols}
    \begin{multicols}{3}
    \item $\text{residual} =81 – 72.378 = 8.622$
    \item $\text{residual} =24 – 25.475 = - 1.475$
    \end{multicols}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
    \begin{multicols}{3}
        \item $\text{Context 1: SSR}=0.1229, s2 = 0.0307$
        \item $\text{Context 2: SSR}=521.268, s2 = 26.06$
        \item $\text{Context 3: SSR}=72.7617, s2 = 18.19$
    \end{multicols}
    \end{enumerate}
    \begin{enumerate}[resume]
    \begin{multicols}{3}
        \item $\text{Context 4: SSR}=687.369, s2 = 98.196$
        \item $\text{Context 5: SSR}=4.4762, s2 = 0.746$
    \end{multicols}
    \end{enumerate}
    \item
    \begin{enumerate}
        \item 
        \item $\text{SSR}=7.3493, s2 = 0.262$
    \end{enumerate}
\end{enumerate}
...
\begin{multicols}{2}
\begin{enumerate}
    \item $8.99>2.776$ so reject $\text{H}_0$
    \item $-23.94 < -1.942$ so reject $\text{H}_0$
    \item $11.75 > 2.763$ so reject $\text{H}_0$
    \item $51.62 > 2.947$ so reject $\text{H}_0$
\end{enumerate}
\end{multicols}
