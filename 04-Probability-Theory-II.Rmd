...
Similarly, the complement rule applies under conditioning: $\text{P}(\overline{A}|B)=1-\text{P}(A|B)$.
...
\node[bag] {}
    child {
        node[bag] {$\overline{\text{late}}$}        
            child {
                node[end, label=right:
                    {$\overline{\text{tie}}$\hspace{1.2cm}$\text{P}(\overline{\text{late}}\cap\overline{\text{tie}})=0.08$\hspace{0.5cm}\text{\large{$\ast$}}}] {}
                edge from parent
                node[above] {}
                node[below]  {$0.1$}
            }
...
\node[bag] {}
    child {
        node[bag] {$\overline{\text{condition}}$}        
            ...
            child {
                node[end, label=right:
                    {$\text{positive}$\hspace{0.85cm}$\text{P}(\overline{\text{condition}}\cap \text{positive})=0.0288$}] {}
                edge from parent
                node[above] {$0.03$}
                node[below]  {}
            }
    ...
    child {
        ...
        child {
            ...
            child {
                node[end, label=right:
                    {$\text{positive}$\hspace{0.75cm}$\text{P}(\text{condition}\cap \text{positive})=0.0392$}] {}
                edge from parent
                node[above] {$0.98$}
                node[below]  {}
            }
...
\begin{enumerate}
    ...
    \item[(b) ] $\text{P}(\text{condition | positive})=\dfrac{\text{P}(\text{condition }\cap \text{  positive})}{\text{P}(\text{positive})}=\dfrac{0.0392}{0.068}=0.5765$
\end{enumerate}
