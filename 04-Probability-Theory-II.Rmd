...
\begin{minipage}{.5\textwidth}
  \centering
\begin{tcolorbox}[adjusted title=Independent:, halign = center,halign title = center,colback=red!5,colframe=red!70!black,width=8.5cm]
$\text{P}(A | B)= \text{P}(A)$
\end{tcolorbox}
\end{minipage}%
  \centering
\begin{minipage}{.5\textwidth}
  \centering
\begin{tcolorbox}[adjusted title=Not Independent:,colback=red!5,colframe=red!70!black, halign = center,halign title = center,width=8.5cm]
$\text{P}(A | B)\ne \text{P}(A)$
\end{tcolorbox}
\end{minipage}
\end{figure}
...
\begin{minipage}{.5\textwidth}
  \centering
\tcbset{width=8.5cm}
\begin{tcolorbox}[adjusted title=Multiplication rule:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
...
\begin{minipage}{.5\textwidth}
  \centering
\tcbset{width=8.5cm}
\begin{tcolorbox}[adjusted title=Multiplication rule for independent events:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
