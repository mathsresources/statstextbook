...
\begin{centering}
\tcbset{width=9cm}
\begin{tcolorbox}[adjusted title=Conditional Probability:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
...
\begin{minipage}{.5\textwidth}
  \centering
\begin{tcolorbox}[adjusted title=For Independent $A$ and $B$:, halign = center,halign title = center,colback=red!5,colframe=red!70!black,width=8.5cm]
$\text{P}(A | B)= \text{P}(A)$
\end{tcolorbox}
\end{minipage}%
  \centering
\begin{minipage}{.5\textwidth}
  \centering
\begin{tcolorbox}[adjusted title=For Not Independent $A$ and $B$:,colback=red!5,colframe=red!70!black, halign = center,halign title = center,width=8.5cm]
$\text{P}(A | B)\ne \text{P}(A)$
\end{tcolorbox}
\end{minipage}
\end{figure}
...
\begin{minipage}{.5\textwidth}
  \centering
\tcbset{width=8.5cm}
\begin{tcolorbox}[adjusted title=Multiplication rule for all $A$,$B$:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
...
\begin{minipage}{.5\textwidth}
  \centering
\tcbset{width=8.5cm}
\begin{tcolorbox}[adjusted title=Multiplication rule for independent $A$,$B$:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
...
\begin{centering}
\tcbset{width=9cm}
\begin{tcolorbox}[adjusted title=Bayes' Theorem:, halign title = center,colback=red!5,colframe=red!70!black, halign = center]
