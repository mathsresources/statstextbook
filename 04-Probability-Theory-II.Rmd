...
\node[bag] {}
    child {
        node[bag] {$\overline{\text{late}}$}        
            child {
                node[end, label=right:
                    {$\overline{\text{tie}}$\hspace{1.2cm}$\text{P}(\overline{\text{late}}\cap\overline{\text{tie}})=\text{0.08}$\hspace{0.5cm}\text{\large{$\ast$}}}] {}
                edge from parent
                node[above] {}
                node[below]  {0.1}
            }
    ...
    child {
        ...
        child {
                node[end, label=right:
                    {$\overline{\text{tie}}$\hspace{1.2cm}$\text{P}(\text{late }\cap \overline{\text{tie}})=\text{0.06}$\hspace{0.5cm}\text{\large{$\ast$}}}] {}
                edge from parent
                node[above] {}
                node[below]  {0.3}
            }
