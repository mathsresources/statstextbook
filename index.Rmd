...
The *Advanced Higher Statistics* course aims to provide learners with a sound foundation in statistical knowledge and methods. This textbook has been designed to provide key facts, examples, and exercises to support progression through the course. It covers all major stages of statistical investigations, including:
...
This book is primarily a *course textbook*, with a focus on providing clear notes, selected worked examples and thorough exercises for students working through the Advanced Higher Statistics course. 

One motivation for writing this textbook was to minimise the time spent copying detailed notes in class, freeing up more time to spend exploring and investigating ideas to build a better understanding of each concept introduced. For that reason, it does not aim to provide all the interesting practical activities and discussions which are needed to give students the best possible introduction to statistics. Any delivery of the course using this textbook should therefore be supplemented with such activities and discussions.

The book is designed to be worked through in a linear manner, with many chapters building on the knowledge gained from previous chapters. However, with care it will be possible to change the order of chapters covered. 

Most sections are designed to correspond roughly to one lesson's learning, although some can be tackled in far less time. A typical section contains:
...
Each chapter concludes with a review exercise, with questions written in a style matching that of typical exam questions. These may be useful to set as homework, and suggested marking schemes can be found on the textbook's website.
...
At the time of printing, each link is active and each site is still being maintained. Should that change, updates and any new recommended links can be found on the textbook website.
