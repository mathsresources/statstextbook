...
\begin{center}
    \begin{tikzpicture}
        ...
        \node at (0,0) {$2\sigma \text{ limits: }\mu \text{ }\pm \text{ }2\times\dfrac{\sigma}{\sqrt{n}}$};
        \node at (5,0) {$3\sigma \text{ limits: }\mu \text{ }\pm \text{ }3\times\dfrac{\sigma}{\sqrt{n}}$};
        \draw[decorate, 
	decoration = {brace,
...
\begin{enumerate}
    \item[(a)] $2\sigma$ limits: $\mu \text{ }\pm \text{ } 2\times\dfrac{\sigma}{\sqrt{n}}=300\text{ }\pm\text{ }2\times\dfrac{5}{\sqrt{4}}=300\text{ }\pm\text{ }5$, so $295$ and $305$.
