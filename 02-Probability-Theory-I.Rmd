...
$$\text{P}(\text{rolling a }5)=\dfrac{1}{6}$$
...
These four outcomes *are* equally likely, so the probability is *one-in-four*, or: $\text{P}(\text{both tails})=\frac{1}{4}$.
        ...
        node[bag] {not six}        
            ...
            child {
                node[end, label=right:
                    {not diamond}] {}
                edge from parent
                node[above] {$\dfrac{3}{4}$}
                node[below]  {}
            }
            edge from parent 
            node[above] {}
            node[below]  {$\dfrac{5}{6}$}
    }
    child {
        node[bag] {six}        
        child {
                node[end, label=right:
                    {diamond\hspace{1.4cm}$\text{P}(\text{six }\textbf{and}\text{  diamond})=\dfrac{1}{6}\times\dfrac{1}{4}=\dfrac{1}{24}$}] {}
                edge from parent
                node[above] {}
                node[below]  {$\dfrac{1}{4}$}
            }
...
\[\text{i.e.}\;\frac{1}{6}+\frac{5}{6}=1\;\text{ and }\;\frac{3}{4}+\frac{1}{4}=1\]
...
\node[bag] {}
    child {
        node[bag] {red}        
            child {
                node[end, label=right:
                    {red\hspace{1.2cm}$\text{P}(\text{both red})=\dfrac{6}{10}\times\dfrac{5}{9}=\dfrac{30}{90}=\dfrac{1}{3}$}] {}
                edge from parent
                node[above] {}
                node[below]  {$\dfrac{5}{9}$}
            }
            child {
                node[end, label=right:
                    {blue}] {}
                edge from parent
                node[above] {$\dfrac{4}{9}$}
                node[below]  {}
            }
            edge from parent 
            node[above] {}
            node[below]  {$\dfrac{6}{10}$}
    }
    child {
        node[bag] {blue}        
        child {
                ...
                edge from parent
                node[above] {}
                node[below]  {$\dfrac{6}{9}$}
            }
            child {
                node[end, label=right:
                    {blue}] {}
                edge from parent
                node[above] {$\dfrac{3}{9}$}
                node[below]  {}
            }
        edge from parent         
            node[above] {$\dfrac{4}{10}$}
            node[below]  {}
    };
\end{tikzpicture}
...
\begin{enumerate}
    ...
    \item Given events $H$ and $J$ such that $\text{P}(H)=\dfrac{3}{8}$, \mbox{\text{$\text{P}(H\cup J)=\dfrac{7}{9}$}} and $\text{P}(H\cap J)=\dfrac{1}{4}$, find $\text{P}(\overline{J})$.
