...
When each outcome in the sample space can be reasonably assumed to be \mbox{\textbf{equally likely}}, then the probability of outcomes or events can be determined. This is called *theoretical probability*.
