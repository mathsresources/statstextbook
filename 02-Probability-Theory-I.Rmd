...
\begin{tcolorbox}[center,adjusted title=Probability of an Event,colback=red!5,colframe=red!70!black,width=13cm,halign = center,halign title = center]
\vspace{-0.3cm}
...
\begin{minipage}[c]{.5\textwidth}
  \centering
\begin{tcolorbox}[adjusted title=For Mutually Exclusive events $A$ and $B$:,colback=red!5,colframe=red!70!black, halign = center,halign title = center,width=8cm,height=1.8cm]
$\text{P}(A\cap B)=0$
\end{tcolorbox}
\end{minipage}
\end{figure}
...
\begin{minipage}[c]{.5\textwidth}
  \centering
\begin{tcolorbox}[adjusted title=For Exhaustive events $A$ and $B$:,colback=red!5,colframe=red!70!black, halign = center,halign title = center,width=8cm,height=1.8cm]
$\text{P}(A\cup B)=1$
\end{tcolorbox}
\end{minipage}
\end{figure}
...
\begin{minipage}[c]{.4\textwidth}
  \centering
\begin{tcolorbox}[adjusted title=The Complement of $A$:,colback=red!5,colframe=red!70!black, halign = center,halign title = center,width=6cm,height=1.8cm]
...
\begin{minipage}[c]{.6\textwidth}
  \centering
\begin{tcolorbox}[adjusted title=The Addition Rule for events $A$ and $B$:, halign title = center,colback=red!5,colframe=red!70!black, halign = center,width=9cm,height=1.8cm]
